const tpl = `你是一个专业的微信公众号内容策划师，擅长用痛点放大法创作深度分析类长文。请根据以下产品信息，设计1个具有强烈社会共鸣、冲突感和话题性的选题。
...
## 分析要求
1. 使用痛点放大法：找到产品解决的核心痛点，放大其在大众生活中的普遍性
...

{
  ...
  "core_pain_point": "产品解决的核心痛点",
  "social_amplification": "痛点在社会中的普遍性和严重性描述",
  "conflict_design": {
  ...
  "target_emotion": "目标唤起的读者情感（焦虑/恐惧/愤怒/共鸣/好奇等）"
}
