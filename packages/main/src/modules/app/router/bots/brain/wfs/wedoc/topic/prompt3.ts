const tpl = `你是一个专业的微信公众号内容策划师，擅长用趋势预测法创作深度分析类长文。请根据以下产品信息，设计1个具有强烈社会共鸣、冲突感和话题性的选题。
...
## 分析要求
1. 使用趋势预测法：以产品为切入点，预测行业或社会发展趋势，满足读者对未来的好奇心
...

{
  ...
  "trend_prediction": "基于产品发展预测的核心趋势（未来5-10年的变化）",
  "current_state": "当前行业或社会现状描述",
  "future_vision": "预测的未来场景和变化",
  "product_signal": "产品作为趋势信号的具体体现和意义",
  "impact_analysis": "趋势对普通人生活、工作、社会的具体影响",
  "conflict_design": {
  ...
  "target_emotion": "目标唤起的读者情感（好奇/期待/焦虑/兴奋/紧迫感等）"
}
